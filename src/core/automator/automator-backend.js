...
export const AUTOMATOR_VAR_TYPES = Object.freeze({
...
export const RESERVED_KEYWORDS = [
  'if', 'else', 'while', 'var', 'function', 'return',
  'true', 'false', 'null', 'undefined', 'this',
  'auto', 'pause', 'notify', 'studies', 'wait', 'start', 'unlock',
  'eternity', 'infinity', 'reality', 'dilation', 'ec', 'bh', 'respec'
];
...
export const AutomatorBackend = {
  ...
  */
  ...
  getVariable(name) {
    return player.reality.automator.variables[name];
  },
  
  setVariable(name, value) {
    player.reality.automator.variables[name] = value;
  },
  ...
  start(scriptID = this.state.topLevelScript, initialMode = AUTOMATOR_MODE.RUN, compile = true) {
    ...
    player.reality.automator.variables = {};
