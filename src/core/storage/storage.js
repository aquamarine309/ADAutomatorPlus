...
export const GameStorage = {
  ...
  get localStorageKey() {
    return DEV ? "dimensionTestSaveRandomVer" : "dimensionSaveRandomVer";
  },

  backupDataKey(saveSlot, backupSlot) {
    return DEV ? `backupTestSaveRandomVer-${saveSlot}-${backupSlot}` : `backupSaveRandomVer-${saveSlot}-${backupSlot}`;
  },

  backupTimeKey(saveSlot) {
    return DEV ? `backupTestTimesRandomVer-${saveSlot}` : `backupTimesRandomVer-${saveSlot}`;
  },
